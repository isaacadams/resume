                ...
                <div className="content">
                    <Header y={{
                        ...
                        bottom: {
                            ...
                            right: <a href="https://github.com/isaacadams" ><FontAwesomeIcon icon={["fab", "github"]} /> isaacadams</a>
                            //right: "(610) 742 6276"
                        }
                    }} />
                    <YSpacer space="15px" />
                    <History title="Technical Skills">
                        <div className="row">
                            ...
                            <div className="col">
                                <Skill category="Technology" examples={[".NET Core", "React", "GRPC", "SignalR", "Node.js", "Angular", "EF Core", "jQuery", "NUnit", "REST", "MVC"]} />
                                <YSpacer />
